...
__DIRS_TO_DEPLOY_LIST__ = [{"id": "seren",       "value": {"name": "plugin.video.seren",         "dest": os.path.join(".kodi", "addons")}},
                           ...
                           {"id": "fanfilm",     "value": {"name": "plugin.video.fanfilm",       "dest": os.path.join(".kodi", "addons")}},
                           {"id": "cdapl",       "value": {"name": "plugin.video.cdapl",         "dest": os.path.join(".kodi", "addons")}},
                           {"id": "repository",  "value": {"name": "repository.vonsagar",        "dest": os.path.join(".kodi", "addons")}},
